    ...
    <div className="flex flex-col h-full items-center justify-center gap-4 py-2">
      {documentAnalysisEnabled ? (
        <motion.button
          ...
          className="flex tour-upload-btn w-full h-16 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl font-black text-sm shadow-xl shadow-blue-500/30 items-center justify-center gap-3 relative overflow-hidden group"
        >
